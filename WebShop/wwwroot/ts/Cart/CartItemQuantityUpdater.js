...
class CartItemQuantityUpdater {
    ...
    handleInputFocusLostAsync(input) {
    ...
    postChangedInputValue(input) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield fetch(`Cart/ChangeCartItemQuantity?cartItemId=${cartItemId}&newQuantity=${newQuantity}`, {
                    method: "POST",
                    headers: {
